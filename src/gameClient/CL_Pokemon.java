...
//        	_speed = s;
    ...
    @Override
    public int compareTo(@NotNull CL_Pokemon cl_pokemon) {
        int ans = 0;
        //if the tag of this node info is bigger return 1
        if (this.getValue()- cl_pokemon.getValue() > 0){
            ans = -1;
        }
        //if the tag of this node info is smaller return -1
        else if (this.getValue()-cl_pokemon.getValue() < 0){
            ans = 1;
        }
    ...
    public void setInTheWay(int inTheWay) {
